...
- ~~Commands for creating, managing and building Steel projects~~
- ~~Integration with Steel compiler and tools~~
- ~~Debugging support for Steel applications~~

## Installation
The extension is not yet complete therefore it is advised not to install it. If you truly wish to install it at this stage you can package the extension folder `steel-vsc/steel` and install it manually.